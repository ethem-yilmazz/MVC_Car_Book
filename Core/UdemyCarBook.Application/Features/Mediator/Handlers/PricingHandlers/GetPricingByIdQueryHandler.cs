...
{
    public class GetPricingByIdQueryHandler : IRequestHandler<GetPricingByIdQueries, GetPricingByIdQueryResult>
    {
        ...
        public async Task<GetPricingByIdQueryResult> Handle(GetPricingByIdQueries request, CancellationToken cancellationToken)
        {
